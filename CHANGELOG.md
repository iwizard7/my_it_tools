...
- Verified Debian Gateway compatibility with Raspberry Pi 3B, 3B+, 4 and 5.
- Removed the hard-coded ARMv7 Docker platform so Docker selects native ARMv7/ARM64 automatically.
- Updated Raspberry Pi documentation with native Python and Docker compatibility guidance.
...
- Interactive mode asks which components to install and whether to flash a connected ESP32.
- Added `--non-interactive` for CI and headless servers.
