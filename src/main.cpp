...
<main>
  ...
  <div class="layout">
    <nav class="nav">
      ...
      <div class="navgroup"><h3>Transform</h3><button data-tool="base64">🔤 Base64</button><button data-tool="url">🔗 URL encoder</button><button data-tool="json">{ } JSON tools</button><button data-tool="stats">📊 Text statistics</button><button data-tool="toolbox">🧰 Encoders & security</button></div>
    ...
    <section class="card">
      ...
      <div id="toolbox" class="tool"><h2>Encoders, security & DevOps</h2><p class="hint">Local tools for secrets, releases, Docker, Kubernetes and SRE work.</p><select id="toolSelect"><option value="sha256">SHA-256 hash</option><option value="hmac">HMAC note</option><option value="strength">Password strength</option><option value="jwtverify">JWT signature verification</option><option value="secretScan">Secret scanner</option><option value="sla">SLA / error budget</option><option value="semver">SemVer comparator</option><option value="commit">Conventional Commit validator</option><option value="docker">Docker image parser</option><option value="k8s">Kubernetes quantity converter</option><option value="checklist">Deployment checklist</option><option value="html">HTML entities</option><option value="unicode">Text ↔ Unicode</option><option value="binary">Text ↔ binary</option><option value="hex">Text ↔ hexadecimal</option><option value="case">Case converter</option><option value="slug">Slugify string</option><option value="jwt">JWT decoder</option><option value="urlparse">URL parser</option><option value="jsoncsv">JSON array ↔ CSV</option><option value="ipv4">IPv4 subnet calculator</option><option value="mac">MAC address generator</option><option value="port">Random port generator</option><option value="ipv6">IPv6 ULA generator</option><option value="ulid">ULID generator</option><option value="nanoid">NanoID generator</option><option value="lorem">Lorem Ipsum</option><option value="fake">Fake test data</option><option value="svg">SVG placeholder</option><option value="cron">Cron template</option><option value="diff">Simple text diff</option><option value="wifiscan">Wi‑Fi scanner</option><option value="net">Network diagnostic</option><option value="filehash">File SHA-256</option></select><br><br><textarea id="toolInput" placeholder="Input..."></textarea><br><input id="toolFile" type="file" style="margin-top:10px"><br><br><button id="toolRun">Run tool</button><button id="toolClear" class="secondary">Clear</button><div id="toolOutput" class="output"></div></div>
  ...
  <footer>ESP32-C3 · local-only tools · Wi-Fi AP: ESP32-Random-Tools · v1.6.1</footer>
</main>
<script>
